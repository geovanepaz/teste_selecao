...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Nov-2016 às 11:06
...
--
ALTER TABLE `produtos_cores`
  ADD CONSTRAINT `produtos_cores_ibfk_1` FOREIGN KEY (`id_cor`) REFERENCES `cores` (`id`),
  ADD CONSTRAINT `produtos_cores_ibfk_2` FOREIGN KEY (`id_produto`) REFERENCES `produtos` (`id`);
